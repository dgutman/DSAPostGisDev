...
from utils import get_tile_metadata, imwrite, get_filename, blob_detect, read_yolo_label, im_to_txt_path,corners_to_polygon,convert_box_type,tile_roi_with_labels, tile_roi_with_labels_wrapper
...
save_dir = '/Users/arjita/Desktop/GrayMatter/DSAPostGisDev/annotationBrowser/yolo/images'
src_dir_labels = '/Users/arjita/Desktop/GrayMatter/DSAPostGisDev/annotationBrowser/yolo'
...
SAVE_DIR = '/Users/arjita/Desktop/GrayMatter/DSAPostGisDev/annotationBrowser/yolo'
fps = glob.glob("/Users/arjita/Desktop/GrayMatter/DSAPostGisDev/annotationBrowser/yolo/images/*.png")
...
def run_yolo_model():
    model = YOLO('/Users/arjita/Desktop/GrayMatter/DSAPostGisDev/annotationBrowser/yolo/best.pt')
    results = model.predict(
        '/Users/arjita/Desktop/GrayMatter/DSAPostGisDev/annotationBrowser/yolo/tiles/images/',
        conf=0.3, save_txt=True, save_conf=True, save=True, hide_conf=True, hide_labels=True
    )
...
predictions_folder = "/Users/arjita/Desktop/GrayMatter/DSAPostGisDev/annotationBrowser/runs/detect/predict"
    ...
    for filename in os.listdir(folder):
        if filename.endswith(".png"):
            ...
            with open(path, "rb") as f:
                ...
                images.append({"name": filename, "image": f"data:image/png;base64,{encoded_image}"})
    return images

@callback(
    Output("image-display", "children"),
    [Input("image-display", "id")]
)
def update_images(_):
    ...
    image_cards = [
        dbc.Col(dbc.Card(
            dbc.CardImg(id=f"image-{i}", src=image["image"], top=True, style={"width": "100%", "height": "auto"})
